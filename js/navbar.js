...
(function () {
  ...
  var headerHTML =
    ...
    '<span class="brand__word">VELOX</span>' +
    '</a>' +
    ...
    '<a href="' + hrefFor('login.html') + '" class="btn btn--primary header__cta">Login / Sign Up</a>' +
    ...
    '<a href="' + hrefFor('login.html') + '" class="btn btn--primary btn--block">Login / Sign Up</a>' +
    '</div>' +
    '</nav>' +
    '</header>';
  ...
  var footerHTML =
    ...
    '<li><a href="' + hrefFor('login.html') + '">Rider Login</a></li>' +
    '</ul>' +
    '</div>' +
    '<div class="footer__col">' +
    ...
    '<span class="small-caps">© 2026 Velox Bicycles  Pvt. Ltd.</span>' +
    '</div>' +
    '</footer>';
